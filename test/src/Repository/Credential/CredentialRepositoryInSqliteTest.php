...
use App\Repository\Credential\CredentialRepositoryInSqlite;
use App\Utils\Clock;
use PHPUnit\Framework\Attributes\Before;
use Test\DbCustomTestCase;

class CredentialRepositoryInSqliteTest extends DbCustomTestCase {
    ...
    public function testRepository(): void {
        $repository = new CredentialRepositoryInSqlite();
