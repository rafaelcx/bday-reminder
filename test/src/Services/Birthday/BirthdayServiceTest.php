...
class BirthdayServiceTest extends DbCustomTestCase {
    ...
    public function testService_Add_ShouldAddBirthdaysFromAllUsers(): void {
        ...
        $update_1 = new Message(
            ...
            message_id: '10',
            user_uid: $user_1->uid,
            text: 'bday add "Name One" 1995-11-30',
        );
        ...
        $update_2 = new Message(
            ...
            message_id: '20',
            user_uid: $user_2->uid,
            text: 'bday add "Name Two" 2000-01-01',
        );
    ...
    public static function provideSkipableUpdateText(): iterable {
        yield ['not_bday_service not_add'];
        yield ['not_bday_service not_add "Name"'];
        yield ['not_bday_service not_add "Name" 2025-01-01'];
        
        yield ['bday not_add'];
        yield ['bday not_add "Name"'];
        yield ['bday not_add "Name" 2025-01-01'];

        yield ['not_bday_service add'];
        yield ['not_bday_service add "Name"'];
        yield ['not_bday_service add "Name" 2025-01-01'];
    ...
    public function testService_Add_ShouldSkip(string $text): void {
        ...
        $this->assertCount(0, $user_1_birthdays);
    }
    ...
    public static function provideMalformedUpdateTextParams(): iterable {
        yield ['bday add'];
        yield ['bday add "Name but no date"'];
    }
