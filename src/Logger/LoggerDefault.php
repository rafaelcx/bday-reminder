...
class LoggerDefault implements LoggerInterface {
    ...
    public function log(mixed $level, \Stringable|string $message, array $context = []): void {
        ...
        $updated_logs = JsonEncoder::safeEncode($previous_logs, JSON_PRETTY_PRINT);
    ...
    public function cleanLogFile(): void {
        ...
        $updated_logs = JsonEncoder::safeEncode($logs, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES);
        FileServiceResolver::resolve()->putFileContents($this->log_file, $updated_logs);
    }
     ...
     * @return mixed[]
     */
    private function buildLogDocument(mixed $level, \Stringable|string $message, array $context): array {
        $log_common_fields = [
